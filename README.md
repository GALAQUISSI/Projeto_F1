...
Future stages of the project aim to create a Virtual Race Engineer system capable of:
...
A fully functional Virtual Race Engineer assistant
Machine learning models for lap time prediction and performance analysis

Inspiration: 
My inspiration for this project comes from a lifelong passion for motorsport, especially Formula 1, that started in my childhood. Since I was very young, I’ve been fascinated by racing, the incredible speed of the cars, the sound of the engines, and the beauty of their aerodynamic design. There is something unique about watching these machines operate at the limit of engineering and human performance.
Over the years, I’ve spent a lot of time watching races, including Formula 1, WEC, and other motorsport categories. I also enjoy watching classic and historic races, which helps me appreciate how the sport has evolved technically and strategically over time.
...
Because of this, I wanted to build a project that combines two things I truly enjoy: motorsport and data analysis. The goal is to explore how telemetry data can be captured, processed, and analyzed to better understand performance and eventually create tools similar to those used by real race engineers.
