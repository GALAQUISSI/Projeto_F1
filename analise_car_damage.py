...
df = pd.read_csv(r'C:\Users\User\Projeto_F1\treino_livre_interlagos_180626\car_damage.csv')
...
for texto_hex, tempo in zip(lista_hex, lista_tempo):
  ...
  linha = {
   ...
   'rl_tyre_blisters' : tyre_blisters[0],
   'rr_tyre_blisters' : tyre_blisters[1],
   'fl_tyre_blisters' : tyre_blisters[2],
   'fr_tyre_blisters' : tyre_blisters[3],
...
df_final.to_csv("translated_car_damage_treino_livre.csv", index=False)